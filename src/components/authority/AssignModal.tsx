...
export function AssignModal({ issue, onClose, onAssign }: AssignModalProps) {
  ...
  const suggestion = `Deploy specialized repair unit to ${issue.address}. Category [${issue.category}] requires immediate intervention to maintain grid stability.`;
